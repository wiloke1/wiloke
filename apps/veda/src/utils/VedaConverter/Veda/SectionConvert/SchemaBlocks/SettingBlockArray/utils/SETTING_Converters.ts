...
import { SettingArray } from '../@types/SettingBlockArray';
...
export const SETTING_Converters: Record<SettingArray['children'][number]['children'][number]['type'], Converters | undefined> = {
