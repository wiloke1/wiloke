 ...
 * @link https://shopify.dev/api/liquid/filters/html-filters#payment_button
 */
export const payment_button = (liquid: string) => {
  return liquid.replace(/{{\s*form\s*\|\s*payment_button\s*}}/gm, () => {
    return `
    <div
