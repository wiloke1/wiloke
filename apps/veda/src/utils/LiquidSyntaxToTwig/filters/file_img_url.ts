...
window.Twig.extendFilter('file_img_url', () => {
  throw new LiquidSyntaxToTwigError(i18n.t('twig_error.filters.file_img_url'));
});
...
export const file_img_url = (liquid: string) => liquid;
