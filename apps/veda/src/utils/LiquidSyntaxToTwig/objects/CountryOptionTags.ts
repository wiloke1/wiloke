export type CountryOptionTags = string;

/**
 * @link https://shopify.dev/api/liquid/objects#country_option_tags
 * NOTE: Không cần thiết lắm
 */
export const country_option_tags: CountryOptionTags = `
 ...
 <option value="British Indian Ocean Territory" data-provinces="[]">
 ...
 <option value="Lao People's Democratic Republic" data-provinces="[]">
   Laos
 </option>,
 ...
 <option value="Palestinian Territory, Occupied" data-provinces="[]">
