...
export const builderPage = {
  ...
  shopify_entity_non_exist: {
    ...
    collection: 'Collection không tồn tại hoặc đã bị thay đổi. Vui lòng chọn trước khi tiếp tục',
    product: 'Product không tồn tại hoặc đã bị thay đổi. Vui lòng chọn trước khi tiếp tục',
    blog: 'Blog không tồn tại hoặc đã bị thay đổi. Vui lòng chọn trước khi tiếp tục',
  },
  fields: {
