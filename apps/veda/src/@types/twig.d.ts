...
export interface CompiledSubexpressionToken extends CompiledGenericTokenWithMatch<'Twig.expression.type.subexpression.end', ')'> {
  expression: boolean;
...
export type CompiledToken = CompiledTokenWithoutMatch | CompiledTokenWithMatch | CompiledSubexpressionToken | CompiledBinaryOperatorToken;
...
export function extendFilter(name: string, definition: (left: any, params: any[] | false) => any): void;
