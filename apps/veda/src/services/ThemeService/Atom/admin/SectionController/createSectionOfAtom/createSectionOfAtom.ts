...
/** API được sử dụng để tạo section - được clone từ section atom - được sử dụng tại theme atom */
export const createSectionOfAtom = async ({ section }: CreateSectionOfAtom) => {
