...
interface CreateCategoryOfDraft {
...
/** API cho phép "Dev" tạo ra "Category" -> Phục vụ cho "Dev và Admin" filter "Addon draft" */
export const createCategoryOfDraft = async ({ category }: CreateCategoryOfDraft) => {
