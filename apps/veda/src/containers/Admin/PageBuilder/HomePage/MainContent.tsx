...
import { authSelector, homePageSelector } from 'store/selectors';
import { i18n } from 'translation';
import { getDate, timeAgo } from 'utils/timeAgo';
import { View, ViewportTracking } from 'wiloke-react-core';
import { useChangeSearchKey, useDeleteHomePages, useLoadMoreHomePage, useSelectManyItems, useSetFilterType, useUpdateStatusHomePage } from '.';
...
export const MainContent = () => {
  ...
  const setPublished = useUpdateStatusHomePage();
  ...
  const loadMoreRequest = useLoadMoreHomePage();
  const deletePageRequest = useDeleteHomePages();
