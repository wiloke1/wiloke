...
import { useChangeSearchKey, useDeleteSearchPages, useLoadMoreSearchPage, useSelectManyItems, useSetFilterType, useUpdateStatusSearchPage } from '.';
...
export const MainContent = () => {
  ...
  const setPublished = useUpdateStatusSearchPage();
  ...
  const loadMoreRequest = useLoadMoreSearchPage();
  const deletePageRequest = useDeleteSearchPages();
